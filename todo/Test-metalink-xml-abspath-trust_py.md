...
This is to test if Metalink/XML forbids absolute paths. With --trust-server-names, trust the metalink:file names.
...
ExpectedFiles = ['File2', 'File5', 'test.metalink']
Running Test Test-metalink-xml-abspath-trust.py
Running Test Test-metalink-xml-abspath-trust.py
/Users/dave/.cargo/bin/wgetf --debug --no-config --trust-server-names --input-metalink test.metalink 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--trust-server-names', '--input-metalink', 'test.metalink']
{'HOME': '/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-abspath-trust.py-test'}
...
Traceback (most recent call last):
  File "/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-abspath-trust.py", line 96, in <module>
    err = Meta.http_test (
        "--trust-server-names " + \
