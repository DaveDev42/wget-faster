...
### stdout
```
--2025-11-15 13:44:12--  http://localhost:56796/File1
Resolving localhost... 
Connecting to localhost:56796... connected.
HTTP request sent, awaiting response... 
Saving to: 'File1'

--2025-11-15 13:44:12--  http://localhost:56796/File2
Resolving localhost... 
Connecting to localhost:56796... connected.
HTTP request sent, awaiting response... 
Saving to: 'File2'
...
/Users/dave/.cargo/bin/wgetf --debug --no-config --user=Pacman --password=Omnomnom http://localhost:56796/File1 http://localhost:56796/File2 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--user=Pacman', '--password=Omnomnom', 'http://localhost:56796/File1', 'http://localhost:56796/File2']
