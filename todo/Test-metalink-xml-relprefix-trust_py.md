...
Running Test Test-metalink-xml-relprefix-trust.py
Running Test Test-metalink-xml-relprefix-trust.py
/Users/dave/.cargo/bin/wgetf --debug --no-config --trust-server-names --directory-prefix ../dir --input-metalink test.metalink 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--trust-server-names', '--directory-prefix', '../dir', '--input-metalink', 'test.metalink']
{'HOME': '/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-relprefix-trust.py-test'}
...
Traceback (most recent call last):
  File "/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-relprefix-trust.py", line 96, in <module>
    err = Meta.http_test (
        "--trust-server-names " + \
