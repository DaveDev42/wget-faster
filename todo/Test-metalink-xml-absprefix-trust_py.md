...
This is to test Metalink/XML absolute directory prefix support in Wget. With --trust-server-names, trust the metalink:file names.
...
ExpectedFiles = ['File1', 'File5', 'test.metalink']
Running Test Test-metalink-xml-absprefix-trust.py
Running Test Test-metalink-xml-absprefix-trust.py
/Users/dave/.cargo/bin/wgetf --debug --no-config --trust-server-names --directory-prefix /dir --input-metalink test.metalink 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--trust-server-names', '--directory-prefix', '/dir', '--input-metalink', 'test.metalink']
{'HOME': '/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-absprefix-trust.py-test'}
...
Traceback (most recent call last):
  File "/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-absprefix-trust.py", line 96, in <module>
    err = Meta.http_test (
        "--trust-server-names " + \
