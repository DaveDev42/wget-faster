...
This is to test Metalink/XML with an empty directory prefix. With --trust-server-names, trust the metalink:file names.
...
ExpectedFiles = ['subdir/File1', 'subdir/File5', 'test.metalink']
Running Test Test-metalink-xml-emptyprefix-trust.py
Running Test Test-metalink-xml-emptyprefix-trust.py
/Users/dave/.cargo/bin/wgetf --debug --no-config --trust-server-names --directory-prefix '' --input-metalink test.metalink 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--trust-server-names', '--directory-prefix', '', '--input-metalink', 'test.metalink']
{'HOME': '/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-emptyprefix-trust.py-test'}
Error: Expected file subdir/File1 not found..
...
Traceback (most recent call last):
  File "/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-emptyprefix-trust.py", line 96, in <module>
    err = Meta.http_test (
        "--trust-server-names " + \
        "--directory-prefix '' " + \
...
exc.test_failed.TestFailed: Expected file subdir/File1 not found.
