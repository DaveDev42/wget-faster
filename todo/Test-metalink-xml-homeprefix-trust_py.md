...
This is to test Metalink/XML home directory prefix support in Wget. With --trust-server-names, trust the metalink:file names.
...
Running Test Test-metalink-xml-homeprefix-trust.py
Running Test Test-metalink-xml-homeprefix-trust.py
/Users/dave/.cargo/bin/wgetf --debug --no-config --trust-server-names --directory-prefix ~/dir --input-metalink test.metalink 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--trust-server-names', '--directory-prefix', '~/dir', '--input-metalink', 'test.metalink']
{'HOME': '/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-homeprefix-trust.py-test'}
...
Traceback (most recent call last):
  File "/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-homeprefix-trust.py", line 96, in <module>
    err = Meta.http_test (
        "--trust-server-names " + \
