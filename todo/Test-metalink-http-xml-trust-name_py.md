...
Running Test Test-metalink-http-xml-trust-name.py
/Users/dave/.cargo/bin/wgetf --debug --no-config --trust-server-names --metalink-over-http --metalink-index=2 http://localhost:56032/main.metalink 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--trust-server-names', '--metalink-over-http', '--metalink-index=2', 'http://localhost:56032/main.metalink']
...
Traceback (most recent call last):
  File "/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-http-xml-trust-name.py", line 270, in <module>
    err = http_test.begin ()
