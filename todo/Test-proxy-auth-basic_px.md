...
Calling /Users/dave/.cargo/bin/wgetf -d --no-config --user=fiddle-dee-dee --password=Dodgson -e http_proxy=localhost:55874 http://no.such.domain/needs-auth.txt
--2025-11-16 13:36:44--  http://no.such.domain/needs-auth.txt
