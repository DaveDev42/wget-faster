...
### stdout
```
--2025-11-15 13:43:11--  http://localhost:56597/File1
Resolving localhost... 
Connecting to localhost:56597... connected.
HTTP request sent, awaiting response... 
Saving to: 'File1'

--2025-11-15 13:43:11--  http://localhost:56597/File2
Resolving localhost... 
Connecting to localhost:56597... connected.
HTTP request sent, awaiting response... 
Saving to: 'File2'
...
/Users/dave/.cargo/bin/wgetf --debug --no-config --password=TheEye http://localhost:56597/File1 http://localhost:56597/File2 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--password=TheEye', 'http://localhost:56597/File1', 'http://localhost:56597/File2']
