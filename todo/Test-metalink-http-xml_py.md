...
This is to test Metalink/HTTP with Metalink/XML Link headers. With --trust-server-names, trust the metalink:file names.
...
### stdout
```
Running Test Test-metalink-http-xml.py
Running Test Test-metalink-http-xml.py
/Users/dave/.cargo/bin/wgetf --debug --no-config --metalink-over-http --metalink-index=2 http://localhost:56888/main.metalink 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--metalink-over-http', '--metalink-index=2', 'http://localhost:56888/main.metalink']
{'HOME': '/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-http-xml.py-test'}
Error: Expected file main.metalink.meta#2 not found..
...
Traceback (most recent call last):
  File "/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-http-xml.py", line 270, in <module>
    err = http_test.begin ()
...
exc.test_failed.TestFailed: Expected file main.metalink.meta#2 not found.
