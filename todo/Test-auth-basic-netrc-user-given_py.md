...
### stdout
```
--2025-11-16 13:36:50--  http://localhost:55961/File1
Resolving localhost... 
Connecting to localhost:55961... connected.
HTTP request sent, awaiting response... 
Saving to: 'File1'

[2m2025-11-16T04:36:50.292881Z[0m [33m WARN[0m [2m302:[0m HEAD request authentication failed [3mretry_status[0m[2m=[0m401
--2025-11-16 13:36:50--  http://localhost:55961/File2
Resolving localhost... 
Connecting to localhost:55961... connected.
HTTP request sent, awaiting response... 
Saving to: 'File2'

Running Test Test-auth-basic-netrc-user-given.py
/Users/dave/.cargo/bin/wgetf --debug --no-config --user=Sauron http://localhost:55961/File1 http://localhost:55961/File2 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--user=Sauron', 'http://localhost:55961/File1', 'http://localhost:55961/File2']
{'HOME': '/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-auth-basic-netrc-user-given.py-test'}
...
### stderr
```
127.0.0.1 - - [16/Nov/2025 13:36:50] "HEAD /File1 HTTP/1.1" 401 -
127.0.0.1 - - [16/Nov/2025 13:36:50] "HEAD /File1 HTTP/1.1" 401 -
wget-faster: download failed: Invalid response status: 401
wgetf: Invalid response status: 401
127.0.0.1 - - [16/Nov/2025 13:36:50] code 400, message Expected Header Authorization not found
127.0.0.1 - - [16/Nov/2025 13:36:50] "HEAD /File2 HTTP/1.1" 400 -
wget-faster: download failed: Invalid response status: 400
wgetf: Invalid response status: 400
Traceback (most recent call last):
  File "/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-auth-basic-netrc-user-given.py", line 66, in <module>
    ).begin ()
      ~~~~~~^^
