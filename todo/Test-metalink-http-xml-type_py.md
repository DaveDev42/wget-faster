...
### stdout
```
Running Test Test-metalink-http-xml-type.py
Running Test Test-metalink-http-xml-type.py
/Users/dave/.cargo/bin/wgetf --debug --no-config --metalink-over-http --metalink-index=0 http://localhost:59713/main.metalink 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--metalink-over-http', '--metalink-index=0', 'http://localhost:59713/main.metalink']
{'HOME': '/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-http-xml-type.py-test'}
...
Traceback (most recent call last):
  File "/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-http-xml-type.py", line 219, in <module>
    err = http_test.begin ()
...
exc.test_failed.TestFailed: Expected file main.metalink.meta#1 not found.
