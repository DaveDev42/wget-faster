...
This is to test Metalink/HTTP with a malformed base64 Digest header. With --trust-server-names, trust the metalink:file names.
...
Running Test Test-metalink-http-baddigest.py
/Users/dave/.cargo/bin/wgetf --debug --no-config --metalink-over-http http://localhost:56864/main.metalink 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--metalink-over-http', 'http://localhost:56864/main.metalink']
...
Traceback (most recent call last):
  File "/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-http-baddigest.py", line 91, in <module>
    err = http_test.begin ()
