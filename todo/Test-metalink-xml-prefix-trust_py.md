...
This is to test Metalink/XML directory prefix support in Wget. With --trust-server-names, trust the metalink:file names.
...
ExpectedFiles = ['dir/subdir/File1', 'dir/subdir/File5', 'test.metalink']
Running Test Test-metalink-xml-prefix-trust.py
Running Test Test-metalink-xml-prefix-trust.py
/Users/dave/.cargo/bin/wgetf --debug --no-config --trust-server-names --directory-prefix dir --input-metalink test.metalink 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--trust-server-names', '--directory-prefix', 'dir', '--input-metalink', 'test.metalink']
{'HOME': '/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-prefix-trust.py-test'}
Error: Expected file dir/subdir/File1 not found..
...
Usage: wgetf --debug... --no-config --trust-server-names --directory-prefix <PREFIX> --input-file <FILE> [URL]...

For more information, try '--help'.
Traceback (most recent call last):
  File "/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-prefix-trust.py", line 96, in <module>
    err = Meta.http_test (
        "--trust-server-names " + \
...
exc.test_failed.TestFailed: Expected file dir/subdir/File1 not found.
