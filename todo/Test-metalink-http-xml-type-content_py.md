...
Running Test Test-metalink-http-xml-type-content.py
/Users/dave/.cargo/bin/wgetf --debug --no-config --metalink-over-http --content-disposition --metalink-index=0 http://localhost:56880/main.metalink 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--metalink-over-http', '--content-disposition', '--metalink-index=0', 'http://localhost:56880/main.metalink']
...
Traceback (most recent call last):
  File "/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-http-xml-type-content.py", line 219, in <module>
    err = http_test.begin ()
