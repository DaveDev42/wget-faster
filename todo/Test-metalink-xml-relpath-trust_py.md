...
This is to test if Metalink/XML forbids relative paths. With --trust-server-names, trust the metalink:file names.
...
ExpectedFiles = ['File5', 'test.metalink']
Running Test Test-metalink-xml-relpath-trust.py
Running Test Test-metalink-xml-relpath-trust.py
/Users/dave/.cargo/bin/wgetf --debug --no-config --trust-server-names --input-metalink test.metalink 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--trust-server-names', '--input-metalink', 'test.metalink']
{'HOME': '/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-relpath-trust.py-test'}
Error: Expected file File5 not found..
...
Traceback (most recent call last):
  File "/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-relpath-trust.py", line 96, in <module>
    err = Meta.http_test (
        "--trust-server-names " + \
...
exc.test_failed.TestFailed: Expected file File5 not found.
