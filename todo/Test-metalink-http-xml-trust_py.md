...
Running Test Test-metalink-http-xml-trust.py
/Users/dave/.cargo/bin/wgetf --debug --no-config --trust-server-names --metalink-over-http --metalink-index=2 http://localhost:58749/main.metalink 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--trust-server-names', '--metalink-over-http', '--metalink-index=2', 'http://localhost:58749/main.metalink']
...
Traceback (most recent call last):
  File "/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-http-xml-trust.py", line 270, in <module>
    err = http_test.begin ()
...
exc.test_failed.TestFailed: Expected file test1.metalink not found.
