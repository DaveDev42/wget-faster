...
### stdout
```
Running Test Test-metalink-http-xml-type-trust.py
Running Test Test-metalink-http-xml-type-trust.py
/Users/dave/.cargo/bin/wgetf --debug --no-config --trust-server-names --metalink-over-http --metalink-index=0 http://localhost:51663/main.metalink 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--trust-server-names', '--metalink-over-http', '--metalink-index=0', 'http://localhost:51663/main.metalink']
{'HOME': '/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-http-xml-type-trust.py-test'}
...
Traceback (most recent call last):
  File "/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-http-xml-type-trust.py", line 219, in <module>
    err = http_test.begin ()
...
exc.test_failed.TestFailed: Expected file main.metalink not found.
