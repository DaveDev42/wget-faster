...
Running Test Test-metalink-xml-homeprefix.py
Running Test Test-metalink-xml-homeprefix.py
/Users/dave/.cargo/bin/wgetf --debug --no-config --directory-prefix ~/dir --input-metalink test.metalink 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--directory-prefix', '~/dir', '--input-metalink', 'test.metalink']
{'HOME': '/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-homeprefix.py-test'}
...
Traceback (most recent call last):
  File "/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-homeprefix.py", line 96, in <module>
    err = Meta.http_test (
