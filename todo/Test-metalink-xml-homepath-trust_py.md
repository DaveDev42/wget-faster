...
This is to test if Metalink/XML forbids the home path and names beginning with the ~ (tilde) character.
...
ExpectedFiles = ['dir/File4~', 'dir/~/File5', 'test.metalink']
Running Test Test-metalink-xml-homepath-trust.py
Running Test Test-metalink-xml-homepath-trust.py
/Users/dave/.cargo/bin/wgetf --debug --no-config --trust-server-names --input-metalink test.metalink 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--trust-server-names', '--input-metalink', 'test.metalink']
{'HOME': '/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-homepath-trust.py-test'}
Error: Expected file dir/File4~ not found..
...
Usage: wgetf --debug... --no-config --trust-server-names --input-file <FILE> [URL]...

For more information, try '--help'.
Traceback (most recent call last):
  File "/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-homepath-trust.py", line 97, in <module>
    err = Meta.http_test (
        "--trust-server-names " + \
...
exc.test_failed.TestFailed: Expected file dir/File4~ not found.
