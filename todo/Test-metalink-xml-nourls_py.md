...
This is to test Metalink/XML with unknown url types. With --trust-server-names, trust the metalink:file names.
...
ExpectedFiles = ['test.metalink.#1', 'test.metalink.#3', 'test.metalink.#4', 'test.metalink.#5', 'test.metalink']
Running Test Test-metalink-xml-nourls.py
Running Test Test-metalink-xml-nourls.py
/Users/dave/.cargo/bin/wgetf --debug --no-config --input-metalink test.metalink 
['/Users/dave/.cargo/bin/wgetf', '--debug', '--no-config', '--input-metalink', 'test.metalink']
{'HOME': '/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-nourls.py-test'}
...
Traceback (most recent call last):
  File "/Users/dave/Projects/github.com/wget-faster-test/wget-repo/testenv/Test-metalink-xml-nourls.py", line 96, in <module>
    err = Meta.http_test (
